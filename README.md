...
**Blockchain** — Solidity · Ethereum · Hardhat · Foundry · Ethers.js · Web3.js

**Frontend** — React.js · Next.js · TanStack Query · Electron

**Backend** — Go · Node.js

**Tools & AI** — Claude Code · Cursor · DeepSeek · Git

---

## 🏗️ Notable Work

- **Questbot** — Discord bot integrating Web3 data into Sovrun's leaderboard program
- **AISKINS** — AI-powered digital asset system for the metaverse
